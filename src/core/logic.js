...
**🦉 Медиа:**
• Войс/аудио — расшифрую + краткая суть
• Фото/видео — пойму и прокомментирую
• PDF, TXT, код — прочитаю и отвечу
• Ссылка на картинку — скачаю и посмотрю

**🔍 Поиск:**
• Сам решаю, когда гуглить
• Курсы, новости, погода — всё найду

**⏰ Напоминания:**
• "Сыч напомни через час..." — поставлю напоминание
• Реплай на сообщение + "напомни" — вытащу время из контекста

**🎲 Рандом:**
• "Сыч монетка" — орёл/решка
• "Сыч число 1-100" — рандом в диапазоне
• "Сыч кто из нас..." — выберу случайного

**🕵️ Досье:**
• "Сыч кто я?" — твой профиль
• "Сыч расскажи про @юзера" — досье на другого
• "Сыч стата" — статистика токенов

**⚙️ Настройки чата:**
• "Сыч, этот чат про [тема]" — задать тему
• /mute — вкл/выкл режим тишины
• /reset — сброс памяти
• /version — версия бота
